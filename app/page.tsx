        ...
        <div className="container h-full items-center justify-center flex">
          ...
          <div className="flex items-center justify-center z-20 max-w-6xl">
            <div className="flex flex-col items-center">
              ...
              <div className="w-64 h-64 bg-transparent dark:bg-transparent top-20rem rounded-lg mb-1 flex items-center justify-center relative z-50">
              ...
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-x-0 -top-[-10rem] z-0 transform-gpu overflow-hidden blur-3xl sm:top-[10rem]"
              >
                <div
                  style={{
                    clipPath:
